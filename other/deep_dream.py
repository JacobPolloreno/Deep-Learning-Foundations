...
def main():
    """ Script to download and play with Google's Deep Dream NN """
...
#####HELPER FUNCTIONS. I didn't go over these in the video for times sake. They are mostly just formatting functions. Scroll 
 ...
 ############################################################
    ...
    def render_deepdream(t_obj, img0=img_noise, iter_n = 10, step=1.5,
...
#    img0 = PIL.Image.open('pilatus800.jpg')
    img0 = PIL.Image.open('earth.jpg')
    img0 = np.float32(img0)

    # Step 4 - Apply gradient ascent to the layer
